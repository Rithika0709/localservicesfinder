...
const testimonials = [
    { name: "Sarah J.", role: "Homeowner", content: "Found an amazing plumber through ServeEase. The booking process was seamless and the service was top-notch!", rating: 5 },
    { name: "Mike C.", role: "Service Provider", content: "As an electrician, ServeEase has helped me grow my business significantly. The platform is easy to use and brings quality customers.", rating: 5 },
    { name: "Emily D.", role: "Busy Parent", content: "ServeEase saved me so much time finding reliable tutoring for my kids. Highly recommended!", rating: 5 }
];
            ...
            <section className="features-section" id="features">
                <div className="container">
                    <div className="section-header">
                        <h2 className="section-title">Why Choose <span className="gradient-text">ServeEase?</span></h2>
